...
public class StateSetupHelper {
     ...
     */
    public static OrderSetupResult placeOrder(Browser browser, String customerPhone) {
    ...
    /**
     * Rapidly accepts and prepares an order on behalf of the restaurant.
     */
    public static String acceptAndPrepareOrder(Browser browser, String restaurantPhone, String shortOrderId, String outletName) {
        BrowserContext context = browser.newContext(new Browser.NewContextOptions()
                .setPermissions(Arrays.asList("geolocation", "notifications"))
                .setGeolocation(TestConfig.GEO_LAT, TestConfig.GEO_LNG));
        Page page = context.newPage();
    ...
    /**
     * Rapidly fetches the delivery OTP by logging in as the customer.
     */
    public static String getDeliveryOtp(Browser browser, String customerPhone) {
        BrowserContext context = browser.newContext(new Browser.NewContextOptions()
                .setPermissions(Arrays.asList("geolocation", "notifications"))
                .setGeolocation(TestConfig.GEO_LAT, TestConfig.GEO_LNG));
        Page page = context.newPage();
        ...
        try {
            ...
            trackButton.waitFor(new com.microsoft.playwright.Locator.WaitForOptions().setState(com.microsoft.playwright.options.WaitForSelectorState.VISIBLE));
            trackButton.click();
     ...
     */
    public static void ensureRiderIsOnline(Browser browser, String riderPhone) {
        BrowserContext context = browser.newContext(new Browser.NewContextOptions()
                .setPermissions(Arrays.asList("geolocation", "notifications"))
                .setGeolocation(TestConfig.GEO_LAT, TestConfig.GEO_LNG));
        Page page = context.newPage();
